...
public class ImportFileController {
    ...
    public ImportFileController(SimpleCourseService cservice, SimpleQuestionnaireImportService qservice) {
        //notNull(cservice, "'SimpleCourseService' should not be null");
        //notNull(qservice, "'SimpleQuestionnaireImportService' should not be null");
    ...
    private void initialize() throws ServiceException {
        ...
        System.out.println("----------------"+coursedata.size());
