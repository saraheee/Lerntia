 ...
 * This class creates a LocalMaryInterface and uses it to set the Voice and to Speak.
 */
...
public class TextToSpeech {
    ...
    /**
     * @author magdy
     * This Function is Used for the jUnits test
     */
    public boolean testSpeak(String text , float gainValue , boolean daemon , boolean join){
        speak(text,gainValue,daemon,join);
        return true;
    }
