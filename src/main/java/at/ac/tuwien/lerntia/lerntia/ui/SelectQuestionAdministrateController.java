...
public class SelectQuestionAdministrateController implements Runnable {
    ...
    public void initialize() {
        ...
        Thread buttonThread = new Thread(this);
        buttonThread.start();
    ...
    public void refresh() {
        ...
        try {
            ...
            this.stage.close();
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/views/selectQuestionAdministrate.fxml"));
    ...
    public void searchQuestion() {
        ...
        this.stage.close();
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/views/searchQuestions.fxml"));
        fxmlLoader.setControllerFactory(param -> param.isInstance(this) ? this : null);
